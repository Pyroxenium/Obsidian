...
__a:ConsumeKeyword('break')then local cda={}cda.AstType='BreakStatement'bda=cda elseif __a:ConsumeKeyword('goto')then
if not
...
#d_a.Arguments then _aa=_aa..","end end elseif d_a.AstType=='BreakStatement'then _aa="break"elseif d_a.AstType=='GotoStatement'then
_aa="goto "..d_a.Label elseif d_a.AstType=='LabelStatement'then
_aa="::"..d_a.Label.."::"elseif d_a.AstType=='RepeatStatement'then
